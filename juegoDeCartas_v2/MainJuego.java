...
public class MainJuego {
	...
	public static void main(String[] args) {
		...
		Carta c3 = new Carta("Acuaman", new Atributo("Altura",185),new Atributo("Peso", 83), new Atributo("Velocidad", 50), new Atributo("Poder" ,300), new Atributo("Peleas ganadas", 70) );
		...
		Carta c8 = new Carta("Raven", new Atributo("Altura",170), new Atributo("Peso",55), new Atributo("Velocidad",120),new Atributo("Poder",400), new Atributo("Peleas ganadas", 25) );
		Carta c9 = new Carta("Starfire", new Atributo("Altura",180), new Atributo("Peso",70), new Atributo("Velocidad",150), new Atributo("Poder",300), new Atributo("Peleas ganadas", 75));
		Carta c10 = new Carta("Chico bestia", new Atributo("Altura",170), new Atributo("Peso",65), new Atributo("Velocidad",150), new Atributo("Poder",300), new Atributo("Peleas ganadas", 20));
		Carta c11 = new Carta("Terra", new Atributo("Altura",170), new Atributo("Peso",60), new Atributo("Velocidad", 27), new Atributo("Poder", 150), new Atributo("Peleas ganadas", 10));
		...
		c12.addAtributo(new Atributo("Poder", 10));
		...
		Pocima p7 = new PocimaSelectiva("Pocima Selectiva Fuerza", "Poder", 35);
